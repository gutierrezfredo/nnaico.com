  ...
  if (minimal) {
    ...
    return (
      <div className={`relative ${className}`}>
        {/* Chat container */}
        <div className="bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden flex">
          {/* Sidebar - simplified */}
          <div className="hidden lg:flex flex-col w-48 border-r border-gray-200 bg-gray-50/80">
            {/* Sidebar header */}
            ...
            <div className="p-3">
              ...
              <div className="mt-2 space-y-1">
                <div className="flex items-center gap-2 px-2 py-1.5 rounded-lg bg-gray-200/80 text-xs">
                  <span className="w-4 h-4 rounded bg-blue-100 flex items-center justify-center text-[10px]">💬</span>
                  <span className="text-gray-900 font-medium truncate">Support</span>
                </div>
                <div className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-xs">
                  <span className="w-4 h-4 rounded bg-green-100 flex items-center justify-center text-[10px]">⚡</span>
                  <span className="text-gray-600 truncate">Sales</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-3 flex-1">
              ...
              <div className="mt-2 space-y-0.5 text-xs">
                <div className="px-2 py-1.5 rounded-lg bg-gray-200/80">
                  <p className="text-gray-900 font-medium truncate">Current chat</p>
                  <p className="text-gray-400 text-[10px]">Just now</p>
                </div>
                <div className="px-2 py-1.5 rounded-lg">
                  <p className="text-gray-600 truncate">Previous chat</p>
          ...
          <div className="flex-1 flex flex-col p-4">
            <div className="flex-1 space-y-4">
              {conversation.map((msg, index) => (
                ...
                >
                  {msg.role === 'user' ? (
                    <div className="max-w-[80%] bg-gray-100 rounded-3xl px-4 py-2.5">
            ...
            {/* Input field */}
            <div className="mt-4 flex items-center gap-2 bg-white rounded-full px-3 py-2 border border-gray-200">
